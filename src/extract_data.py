...
from src import movenet_depthai as mnet
...
def extract_data(verbose=False):
    ...
    movenet = mnet.MoveNetDepthAI(input_path=file_path)
    ...
    for i in range(1, 31):
        ...
        for j in range(iter_range[0], iter_range[1], iter_range[2]):
            ...
            if verbose:
                ...
                cv2.putText(normDataFrame, file_path, (20, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 4,
                            cv2.LINE_AA)
